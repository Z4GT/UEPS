                        ...
                        <div class="col-xl-4 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent">
                                    ...
                                    <p class="mb-0 text-center" style="color:#4a59a4!important;">Usa tus Preguntas de Seguridad para Recuperarla</p>
                                </div>
                                @if ($errors->any())
                                ...
                                <div class="card-body">
                                    <form role="form" action="/forgot-password" method="POST">
                                        {{ csrf_field() }}
                                        <div class="mb-3">
                                            <p class="mb-0 text-center" style="color:#4a59a4!important;" >Nombre de su primera Mascota</p>
